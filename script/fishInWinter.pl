...
=head1 Name
#coped from :
https://github.com/JinfengChen/Scripts/blob/b8dc884a8c5fc10ed8a45306528734693ca43a84/bin/fishInWinter.pl
...
#	read_table($bait_file,\%Bait,$BaitColumn,"\t");
...
#	output_table($fish_file,\%Bait,$FishColumn,"\t");
...
sub read_fq{
	...
	if($file=~ /gz$/){
		open(IN,"pigz  -p 4 -dc $file|") || die("fail to open $file\n");
        }else{
